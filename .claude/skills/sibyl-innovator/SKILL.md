...
!`.venv/bin/python3 -c "from sibyl.orchestrate import load_prompt, load_common_prompt; print(load_common_prompt()); print('---'); print(load_prompt('innovator'))"`

Topic: $ARGUMENTS[0]
Workspace path: $ARGUMENTS[1]

Write your output to $ARGUMENTS[1]/idea/perspectives/innovator.md
